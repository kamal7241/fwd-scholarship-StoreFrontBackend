...
describe('Product store suite', () => {
    ...
    it('create should return a product', async () => {
        ...
        const {id , ...product} = await store.create(postProduct) as ProductDataBase;
        productId = id;
    ...
    it('update should return a updated product values', async () => {
        ...
        const updatedProduct = await store.update(updateProduct) as ProductDataBase;
        expect(updateProduct).toEqual(updatedProduct);
    });
    it('delete should remove created product', async () => {
        const deletedProduct = await store.delete(productId) as ProductDataBase;
